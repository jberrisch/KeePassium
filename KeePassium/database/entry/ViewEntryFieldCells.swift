...
protocol ViewableFieldCellDelegate: class {
    ...
    /// Cell content has just been expanded to full height
...
class ExpandableFieldCell: ViewableFieldCell {
    ...
    private var heightConstraint: NSLayoutConstraint! // strong
